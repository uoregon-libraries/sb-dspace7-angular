...
@Component({
  selector: 'ds-search-form-site',
  styleUrls: ['./search-form.component-site.scss'],
  templateUrl: './search-form.component-site.html'
})
/**
 * Component that represents the search form
 */
export class SearchFormComponentSite implements OnChanges {
  /**
   * The search query
   */
  @Input() query: string;
